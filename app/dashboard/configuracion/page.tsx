...
export default function ConfiguracionPage() {
  ...
  const handleAparienciaChange = (key: string, value: boolean) => {
    setApariencia({
      ...apariencia,
      [key]: value,
    })
    ...
    toast({
      ...
      description: "La configuración de apariencia se ha actualizado correctamente.",
    })
  }
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    checked={apariencia.altaVisibilidad}
                    onCheckedChange={(checked) => handleAparienciaChange("altaVisibilidad", checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    checked={apariencia.animaciones}
                    onCheckedChange={(checked) => handleAparienciaChange("animaciones", checked)}
                  />
                </div>
              </div>
            </CardContent>
